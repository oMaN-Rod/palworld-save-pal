...
define_message_types! {
    ...
    LoadServerSave => "load_server_save",    GetServerStats => "get_server_stats",
    ServerCreationProgress => "server_creation_progress",
    ImportServer => "import_server",
    GetSignalStatus => "get_signal_status",
    SignalStatusUpdate => "signal_status_update",
    UpdateSignalConfig => "update_signal_config",
    SignalStart => "signal_start",
    SignalStop => "signal_stop",
    SetSignalSource => "set_signal_source",
    ClearSignalSource => "clear_signal_source",
    RegenerateSignalToken => "regenerate_signal_token",
    DiscoverSignalGamedata => "discover_signal_gamedata",
