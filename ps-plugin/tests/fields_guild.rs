...
/// The guild as `ps-core` reads it back off the save, with no part of the
...
fn guild_in_the_save(
    ...
    ps_core::domain::guild::get_guild_details(harness.session_mut(), &game_data, id)
