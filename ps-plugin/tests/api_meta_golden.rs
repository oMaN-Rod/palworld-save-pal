use ps_plugin::host::api_def::api_definition;

#[test]
fn the_meta_file_declares_globals_handles_and_capabilities() {
    let meta = ps_plugin::lua_meta(&api_definition());
...
fn the_meta_file_matches_its_golden() {
    let generated = ps_plugin::lua_meta(&api_definition());
    let golden = include_str!("fixtures/ps.lua");
    assert_eq!(
        generated, golden,
