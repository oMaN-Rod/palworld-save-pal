...
use ps_core::dto::pal::{PalDto, PalGender, WORK_SUITABILITIES};
use ps_core::dto::summary::PalSummary;
...
/// `format_character_key` (`ps-core/src/dto/pal.rs:64-70`) already draws
...
/// `IsRarePal` is gone (`ps-core/src/domain/pal.rs:691-692`). Demoting a
