...
import { buildArchetypeGeometry } from '../mesh/proxyGeometry';
import { ueYawToThreeQuaternion } from '../../geo/coords3d';
import { structurePlacement, structureAnchor } from './structurePlacement';
import { structureFillColor } from '../../style/styles';
import { materialOpacities } from '../../style/mapColors.svelte';
import { DEFAULT_STRUCTURE_FOOTPRINT, lookupFootprint } from '../../features/features';
import {
	structureParts,
	requestMesh,
	meshFailed,
...
} from '../mesh/meshLibrary';
import { partLocalMatrix, type MeshPart } from '../mesh/meshPlacement';
import { PickIndex } from '../picking/pickIndex';
import { decodePickBytes } from '../picking/pickEncoding';
