...
import { resetMapColors, setMaterialOpacity, setMaterialTint } from '../../style/mapColors.svelte';
import type { MeshPart } from '../mesh/meshPlacement';
import type { BaseStructure, Footprint } from '$types';
import { requestMesh, type TexturedMeshBundle } from '../mesh/meshLibrary';
