<script lang="ts">
	import { categoryHref, categoryLabel, WIKI_CATEGORIES, type WikiCategory } from '$lib/utils/wikiCategories';

	let { active }: { active?: WikiCategory } = $props();
</script>

<nav class="flex gap-1 overflow-x-auto border-b border-surface-700 pb-2">
