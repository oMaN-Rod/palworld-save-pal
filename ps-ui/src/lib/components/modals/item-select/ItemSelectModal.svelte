<script lang="ts">
	...
	const cardClass = $derived(
		isEgg ? 'modal-panel w-full max-w-[1200px] min-w-[600px]' : 'modal-panel w-full md:w-[600px]'
	);
	const controlsClass = $derived(isEgg ? 'grid gap-2 md:grid-cols-[570px_1fr]' : 'flex w-full');
