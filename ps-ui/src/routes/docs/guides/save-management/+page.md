...
PalStudio includes conversion tools accessible from the **Tools** page:
...
When using the desktop app, PalStudio automatically creates backups before saving changes. Backups are stored alongside `palstudio.exe`.
