...
description: Learn how to set up and use PalStudio
---

# Getting Started

Welcome to **PalStudio** — a save file editor for Palworld that lets you modify players, Pals, items, and more.

## Installation {.toc}

### Desktop App (Recommended)

1. Download the latest release from the [GitHub releases page](https://github.com/oMaN-Rod/palstudio/releases)
...
> **Important:** Always back up your save files before making modifications. While PalStudio creates automatic backups in desktop mode, it's good practice to maintain your own copies.
