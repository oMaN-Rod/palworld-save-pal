...
// rather than always-on: the cert is self-signed, and ps-desktop/tauri.conf.json
...
export default defineConfig({
	...
	server: {
		...
		port: 5173,
		strictPort: true,
		// The Oodle (ooz) wasm module lives in ps-ui/vendor, outside Vite's default dev
