...
describe('generate-sitemap', () => {
	it('emits hreflang alternates for localized paths', () => {
		...
		expect(xml).toContain('<loc>https://palstudio.app/</loc>');
	...
	it('omits alternates for English-only paths', () => {
		...
		expect(xml).toContain('<loc>https://palstudio.app/wiki/pals/lamball</loc>');
	...
	it('builds an index referencing each child sitemap', () => {
		...
		expect(xml).toContain('https://palstudio.app/sitemaps/pals.xml');
	});
});
