//! The default Tauri webview launcher (Windows/macOS/Linux). Everything here
//! is the desktop app as it existed before `browser-mode` — see `main.rs` for
//! how the two launchers are selected.
