...
mod tests {
    ...
    fn native_record(install_path: &str, workshop_dir: &str) -> ps_db::servers::ServerRecord {
    ...
    /// file, and nothing else in PalStudio ever sets it back, so enabling a mod has to
