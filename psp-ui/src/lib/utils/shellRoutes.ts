...
// The Linux first-run mode-select overlay renders bare: no sidebar, no nav, no
// corner art — the small Tauri window IS the whole interface.
export const CONTROL_ROUTES = ['/mode-select'] as const;
