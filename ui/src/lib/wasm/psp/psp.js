...
export function dispatch_frame(frame_json) {
    const ptr0 = passStringToWasm0(frame_json, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.dispatch_frame(ptr0, len0);
...
export function export_gvas_file(name) {
    ...
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.export_gvas_file(ptr0, len0);
    return takeObject(ret);
}
...
export function export_gvas_manifest() {
    const ret = wasm.export_gvas_manifest();
    return takeObject(ret);
}
...
export function init_game_data(entries) {
    try {
        ...
        wasm.init_game_data(retptr, addHeapObject(entries));
...
export function load_staged_gvas(save_id) {
    const ptr0 = passStringToWasm0(save_id, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.load_staged_gvas(ptr0, len0);
    return takeObject(ret);
}
...
export function set_emit_callback(cb) {
    wasm.set_emit_callback(addHeapObject(cb));
}
...
export function set_oodle_bridge(compress, decompress) {
    wasm.set_oodle_bridge(addHeapObject(compress), addHeapObject(decompress));
}
...
export function set_sql_bridge(exec, query) {
    wasm.set_sql_bridge(addHeapObject(exec), addHeapObject(query));
}
...
export function stage_gvas(slot, uid, bytes) {
    try {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(uid, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passArray8ToWasm0(bytes, wasm.__wbindgen_export);
        const len2 = WASM_VECTOR_LEN;
        wasm.stage_gvas(retptr, ptr0, len0, ptr1, len1, ptr2, len2);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        if (r1) {
            throw takeObject(r0);
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_new_typed_1824d93f294193e5: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return __wasm_bindgen_func_elem_5219(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [Externref], shim_idx: 1220, ret: Result(Unit), inner_ret: Some(Result(Unit)) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, __wasm_bindgen_func_elem_5205);
            return addHeapObject(ret);
        },
...
function __wasm_bindgen_func_elem_5205(arg0, arg1, arg2) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.__wasm_bindgen_func_elem_5205(retptr, arg0, arg1, addHeapObject(arg2));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        if (r1) {
            throw takeObject(r0);
...
function __wasm_bindgen_func_elem_5219(arg0, arg1, arg2, arg3) {
    wasm.__wasm_bindgen_func_elem_5219(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
