...
<div
	class="relative flex min-h-16 max-w-md min-w-60 flex-col items-center justify-center rounded-md border p-4 text-white shadow-md backdrop-blur-sm {colorClasses}"
