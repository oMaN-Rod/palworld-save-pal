				...
				{#each saveOptions as option}
					<button
						...
						class={cn(
							...
							option.disabled
								...
								: 'border-surface-700 hover:border-primary-400/60 hover:shadow-lg hover:-translate-y-0.5 cursor-pointer'
						)}
					...
					>
						<div class="flex flex-col items-center gap-2">
							<div
								class="bg-surface-900 mb-2 flex h-24 w-24 items-center justify-center rounded-full p-4 shadow transition-all duration-200 group-hover:shadow-glow-paldium"
							>
								{@html option.icon}
							</div>
