...
<div class="flex h-full w-full overflow-hidden">
	<div class="relative h-full w-full">
		{#if appState.saveFile}
			<div class="absolute left-2 right-2 top-0 flex min-w-72 flex-row items-center justify-between">
				...
				<a
					...
					class="inline-flex items-center px-3 py-2 mr-2 text-sm font-medium text-white bg-indigo-600 rounded-md hover:bg-indigo-700"
				>
					<svg
						class="w-5 h-5 mr-2"
						fill="currentColor"
