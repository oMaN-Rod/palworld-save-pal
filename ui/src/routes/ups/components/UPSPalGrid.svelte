...
<div class="p-4">
	<div
		class="grid grid-cols-3 place-items-center gap-4 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6"
	>
			...
			<div class="relative">
				...
				<div class="absolute top-2 right-2 text-right">
					{#if upsPal.transfer_count > 0 || upsPal.clone_count > 0}
						<div
							class="bg-surface-950/80 text-surface-100 space-y-1 rounded px-2 py-1 text-xs backdrop-blur-sm"
						>
