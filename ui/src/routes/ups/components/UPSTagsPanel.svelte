	...
	<div class="border-surface-300 dark:border-surface-700 border-b p-4">
		...
		<div class="relative">
			<input
				...
				class="border-surface-300 dark:border-surface-600 dark:bg-surface-800 w-full rounded-md border bg-surface-900 py-2 pr-3 pl-8 text-sm"
			/>
					...
					<div class="group relative">
						...
						>
							<TooltipButton
								...
								class="rounded bg-surface-900/60 p-1 text-surface-200 hover:bg-surface-700/60"
							...
							<TooltipButton
								...
								class="rounded bg-error-500/20 p-1 text-error-300 hover:bg-error-500/40"
