...
pub struct PluginRegistry {
    runs: std::sync::Mutex<std::collections::HashMap<uuid::Uuid, ps_plugin::sandbox::Cancel>>,
}
...
impl PluginRegistry {
    ...
    pub fn register_run(&self, run_id: uuid::Uuid, cancel: ps_plugin::sandbox::Cancel) {
