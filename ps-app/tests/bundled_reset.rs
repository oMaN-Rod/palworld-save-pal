...
fn empty_map_property() -> ps_core::ue::Property {
    ps_core::ue::Property::Map(Vec::new())
}
...
fn seed_top_level_key(session: &mut SaveSession, key: &str) {
    let props = ps_core::domain::world::world_props_mut(&mut session.level)
