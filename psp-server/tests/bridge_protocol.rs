use psp_server::bridge::protocol::{BridgeEndpointFile, BridgeEnvelope, BridgeErrorData};

const AUTH: &str = include_str!("../../psp-amity/fixtures/auth.json");
const AUTH_OK: &str = include_str!("../../psp-amity/fixtures/auth_ok.json");
const CAPABILITIES: &str = include_str!("../../psp-amity/fixtures/capabilities.json");
const COMMAND_HEAL: &str = include_str!("../../psp-amity/fixtures/command_heal.json");
const COMMAND_SET_ITEM_SLOT: &str =
    include_str!("../../psp-amity/fixtures/command_set_item_slot.json");
const COMMAND_RESULT_HEAL: &str = include_str!("../../psp-amity/fixtures/command_result_heal.json");
const COMMAND_RESULT_SET_ITEM_SLOT: &str =
    include_str!("../../psp-amity/fixtures/command_result_set_item_slot.json");
const ERROR_CAPABILITY_UNAVAILABLE: &str =
    include_str!("../../psp-amity/fixtures/error_capability_unavailable.json");
const ERROR_GAME_ERROR: &str = include_str!("../../psp-amity/fixtures/error_game_error.json");
const ERROR_NOT_AUTHORITATIVE: &str =
    include_str!("../../psp-amity/fixtures/error_not_authoritative.json");
const ERROR_QUEUE_FULL: &str = include_str!("../../psp-amity/fixtures/error_queue_full.json");
const ERROR_SHUTTING_DOWN: &str = include_str!("../../psp-amity/fixtures/error_shutting_down.json");
const ERROR_TIMEOUT: &str = include_str!("../../psp-amity/fixtures/error_timeout.json");
const ERROR_UNAUTHORIZED: &str = include_str!("../../psp-amity/fixtures/error_unauthorized.json");
const ERROR_VALIDATION_FAILED: &str =
    include_str!("../../psp-amity/fixtures/error_validation_failed.json");
const GET_CAPABILITIES: &str = include_str!("../../psp-amity/fixtures/get_capabilities.json");
const GET_INVENTORY: &str = include_str!("../../psp-amity/fixtures/get_inventory.json");
const GET_PAL_DETAIL: &str = include_str!("../../psp-amity/fixtures/get_pal_detail.json");
const GET_PALS: &str = include_str!("../../psp-amity/fixtures/get_pals.json");
const GET_PLAYERS: &str = include_str!("../../psp-amity/fixtures/get_players.json");
const GET_STATUS: &str = include_str!("../../psp-amity/fixtures/get_status.json");
const HELLO: &str = include_str!("../../psp-amity/fixtures/hello.json");
const HELLO_OK: &str = include_str!("../../psp-amity/fixtures/hello_ok.json");
const INVENTORY: &str = include_str!("../../psp-amity/fixtures/inventory.json");
const PAL_DETAIL: &str = include_str!("../../psp-amity/fixtures/pal_detail.json");
const PALS: &str = include_str!("../../psp-amity/fixtures/pals.json");
const PLAYERS: &str = include_str!("../../psp-amity/fixtures/players.json");
const STATUS: &str = include_str!("../../psp-amity/fixtures/status.json");
