...
const PALS_FIXTURE: &str = include_str!("../../psp-amity/fixtures/pals.json");
const PAL_DETAIL_FIXTURE: &str = include_str!("../../psp-amity/fixtures/pal_detail.json");
const INVENTORY_FIXTURE: &str = include_str!("../../psp-amity/fixtures/inventory.json");
