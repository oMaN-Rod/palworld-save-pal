...
use ps_core::domain::relic::{self, RELIC_TYPE_MAP, RELIC_TYPE_TO_STATUS_NAME};
...
fn every_relic_has_an_icon_asset() {
    let img_dir = std::path::Path::new(env!("CARGO_MANIFEST_DIR")).join("../ps-ui/src/lib/assets/img");
